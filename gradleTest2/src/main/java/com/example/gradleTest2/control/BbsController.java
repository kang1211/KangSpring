...
/*
	...
	데이터베이스 - mybatis
		...
		BbsController
			...
			저장	 : /write(POST) - public String write(@Valid SimpleBbsDto simpleBbsDto,
			...
			저장	 : /update(POST) - public String update(@Valid SimpleBbsDto simpleBbsDto,
										BindingResult bind, Model model) 메서드
			글삭제 : /delete(GET) - public String delete(@RequestParam String id)메서드
	...
	미팅 - 개발자( 팀장- 개발부서에서 선임 )
	당근 같은 사이트 개발
	로그인, 회원가입 - 회원가입 양식, 본인인증 방식,
	
	게시판 - 작성자 (로그인), 제목X, 내용 O -> 이미지, 표, 링크
	. . .
	요구사항 분석 -> 설계 -> ui/ux , 관리 -> 클래스, DB
