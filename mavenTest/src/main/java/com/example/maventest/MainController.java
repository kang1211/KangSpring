...
/*
 * @PostMapping("/update/User") public ModelAndView updateUser(@ModelAttribute
 * memberDTO memberdto) { ModelAndView mv = new ModelAndView("update");
 * memberService.insert(memberdto); return mv; }
 */
